package com.mbialowas.mvvm_basic_2024.screens
...
import com.mbialowas.mvvm_basic_2024.data.Movie
...
fun DisplayFavoriteMovies(movies: List<Movie>){
    LazyColumn {
        items(movies) { movie ->
            Log.i("FavoriteMovies: ", "Movie Title: ${movie.title} isFavorite: ${movie.isFavorite}")
        }
    }
}
